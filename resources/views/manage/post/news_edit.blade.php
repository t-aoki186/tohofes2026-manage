<x-manage-layout>
    ...
    <div class="pt-10 ml-5 mr-5 pb-10">
        <form action="{{ route('manage.post.news.store') }}" method="POST">
            ...
            <div class="grid grid-cols-3 gap-4 mb-4">
                ...
                <div class="flex flex-col gap-1">
                    <label class="text-gray-400 text-xs ml-2">日付</label>
                    <input type="text" name="date" value="{{ $target['date'] }}" class="bg-[#2c2d30] text-white border border-gray-600 rounded-xl p-3" placeholder="ISO形式の日付">
                </div>
                <div class="flex flex-col gap-1">
            ...
            <div class="mt-6 flex justify-between items-center">
                ...
                <button type="submit" class="bg-blue-600 text-white px-10 py-3 rounded-xl font-bold cursor-pointer hover:bg-blue-700 transition shadow-lg">
                    JSONを更新して公開
                </button>
            </div>
        </form>
