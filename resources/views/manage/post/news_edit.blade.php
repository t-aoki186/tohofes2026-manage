<x-manage-layout>
    ...
    <x-slot:pageTitle>ニュースyをMarkdownで書く</x-slot:pageTitle>


    <form action="{{ route('manage.post.news.store') }}" method="POST" class="flex flex-col gap-4 edit-form">
        @csrf
        {{-- 編集時は元のIDを保持、新規時は空 --}}
        ...
        <div class="mt-6 flex justify-between items-center">
            <a href="{{ route('manage.post.news.index') }}" class="follow-btn">← 一覧に戻る</a>
